const characters = [
    ...
    { name: 'Марік', emoji: '😈' },
    { name: 'Денис', emoji: '😈' },
    { name: 'Святік Монада', emoji: '😈' },
    { name: 'Святік Медвідь', emoji: '😈' },
    { name: 'Деман', emoji: '😈' },
    { name: 'Кепка', emoji: '😈' },
    { name: 'Ілля', emoji: '😈' },
    { name: 'Чопко', emoji: '😈' },
    { name: 'Христя', emoji: '😈' },
    { name: 'Віка Святіка', emoji: '😈' },
    { name: 'Віка Дениса', emoji: '😈' },
    { name: 'Соня', emoji: '😈' },
    { name: 'Вероніка Дуда', emoji: '😈' },
    { name: 'Саня Андеграунд', emoji: '😈' },
    { name: 'Веталь Юхимів', emoji: '😈' },
    { name: 'Макс Дуда', emoji: '😈' },
    { name: 'Іван C#', emoji: '😈' },
    { name: 'Толік', emoji: '😈' },
    { name: 'Чубака', emoji: '😈' },
    { name: 'Данік Лайф', emoji: '😈' },
    { name: 'Клімашевська', emoji: '😈' },
    { name: 'Діма', emoji: '😈' },
    { name: 'Брат Дениса', emoji: '😈' },
